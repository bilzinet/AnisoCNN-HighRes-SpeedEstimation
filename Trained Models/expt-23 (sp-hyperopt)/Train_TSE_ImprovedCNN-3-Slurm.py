...
# Layer 1
nrows = 5; ncols = 5; inp_dep = 3; out_dep = 48;
...
# Layer 3
nrows = 3; ncols = 3; inp_dep = 32; out_dep = 56;
...
# Layer 4
nrows = 5; ncols = 5; inp_dep = 56; out_dep = 40;
...
# Layer 5
nrows = 3; ncols = 3; inp_dep = 40; out_dep = 16;
...
# Layer 6
nrows = 9; ncols = 9; inp_dep = 16; out_dep = 40;
...
# Output layer
nrows = 7; ncols = 7; inp_dep = 40; out_dep = 1;
...
optmzr = keras.optimizers.Adam(lr=0.0001, amsgrad=True)
...
autoencoder.save('./Expt23_model_mask2-{}.h5'.format(loss_fn))
np.save('./Expt23_loss-{}.npy'.format(loss_fn), np.array(loss))
np.save('./Expt23_val_loss-{}.npy'.format(loss_fn), np.array(val_loss))
np.save('./Expt23_mse-{}.npy'.format(loss_fn), np.array(mse))
np.save('./Expt23_val_mse-{}.npy'.format(loss_fn), np.array(val_mse))
