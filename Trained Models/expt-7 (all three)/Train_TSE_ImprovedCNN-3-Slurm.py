...
autoencoder.save('./Expt6_model_mask2-{}.h5'.format(loss_fn))
np.save('./Expt6_loss-{}.npy'.format(loss_fn), np.array(loss))
np.save('./Expt6_val_loss-{}.npy'.format(loss_fn), np.array(val_loss))
np.save('./Expt6_mse-{}.npy'.format(loss_fn), np.array(mse))
np.save('./Expt6_val_mse-{}.npy'.format(loss_fn), np.array(val_mse))
