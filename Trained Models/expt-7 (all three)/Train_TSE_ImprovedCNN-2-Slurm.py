...
max_v = 23.6; max_w = -5.3; w_v = 0.8; w_w = 1.2
...
mask1 = create_mask(max_v,w_v,max_w,w_w,nrows,ncols,inp_dep,out_dep,mask_def1)
...
mask2 = create_mask(max_v,w_v,max_w,w_w,nrows,ncols,inp_dep,out_dep,mask_def1)
...
mask3 = create_mask(max_v,w_v,max_w,w_w,nrows,ncols,inp_dep,out_dep,mask_def1)
...
mask4 = create_mask(max_v,w_v,max_w,w_w,nrows,ncols,inp_dep,out_dep,mask_def1)
...
mask5 = create_mask(max_v,w_v,max_w,w_w,nrows,ncols,inp_dep,out_dep,mask_def1)
...
mask6 = create_mask(max_v,w_v,max_w,w_w,nrows,ncols,inp_dep,out_dep,mask_def1)
...
mask7 = create_mask(max_v,w_v,max_w,w_w,nrows,ncols,inp_dep,out_dep,mask_def1)
...
# output_Y = np.load('./out_dataB.npy')[:,:80,:,:]
...
autoencoder.save('./Expt5_model_mask1-{}.h5'.format(loss_fn))
np.save('./Expt5_loss-{}.npy'.format(loss_fn), np.array(loss))
np.save('./Expt5_val_loss-{}.npy'.format(loss_fn), np.array(val_loss))
np.save('./Expt5_mse-{}.npy'.format(loss_fn), np.array(mse))
np.save('./Expt5_val_mse-{}.npy'.format(loss_fn), np.array(val_mse))
