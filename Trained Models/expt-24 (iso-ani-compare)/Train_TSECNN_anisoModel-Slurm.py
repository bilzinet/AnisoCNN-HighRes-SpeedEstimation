...
# Save model
tse_cnn_model.save('./Expt24_anisomodel_5p-{}.h5'.format(itr))
...
np.save('./Expt24_anisomodel_loss-{}.npy'.format(itr), np.array(loss))
np.save('./Expt24_anisomodel_val_loss-{}.npy'.format(itr), np.array(val_loss))
np.save('./Expt24_anisomodel_rmse-{}.npy'.format(itr), np.array(rmse))
np.save('./Expt24_anisomodel_val_rmse-{}.npy'.format(itr), np.array(val_rmse))
np.save('./Expt24_anisomodel_var-{}.npy'.format(itr), np.array(var))
np.save('./Expt24_anisomodel_val_var-{}.npy'.format(itr), np.array(val_var))
