...
# Save model
tse_cnn_model.save('./Expt24_isomodel_5p-{}.h5'.format(itr))
...
np.save('./Expt24_isomodel_loss-{}.npy'.format(itr), np.array(loss))
np.save('./Expt24_isomodel_val_loss-{}.npy'.format(itr), np.array(val_loss))
np.save('./Expt24_isomodel_rmse-{}.npy'.format(itr), np.array(rmse))
np.save('./Expt24_isomodel_val_rmse-{}.npy'.format(itr), np.array(val_rmse))
np.save('./Expt24_isomodel_var-{}.npy'.format(itr), np.array(var))
np.save('./Expt24_isomodel_val_var-{}.npy'.format(itr), np.array(val_var))
